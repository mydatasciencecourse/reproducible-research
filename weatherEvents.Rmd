...
summedFatalities=sum(averagedByEventtype$fatalities)
summedInjuries=sum(averagedByEventtype$injuries)





topFatalities=orderedByFatalities[orderedByFatalities$fatalities>fatalitiesQuantile[4],]

plot(topFatalities$evtype, topFatalities$fatalities)
